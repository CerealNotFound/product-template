...
export function SignupForm({
  ...
  const signup = (formData: FormData) => {
    ...
    callApi({
      ...
      successMessage: () =>
        "Signed in successfully! Please open your email app to confirm your signup",
      errorMessage: (err) => `Signin failed: ${err.message}`,
      onSuccess: (data) => {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-2 text-center">
        <h1 className="text-2xl font-bold">Signup to our platform</h1>
